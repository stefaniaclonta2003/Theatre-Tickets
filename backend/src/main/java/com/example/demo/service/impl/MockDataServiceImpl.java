...
public class MockDataServiceImpl implements MockDataService {
    ...
    public void generateMockData() {
        ...
        Event event7 = new Event(7L, "Nunta lui Figaro", "Operă comică", LocalDate.of(2025, 8, 12), venue1, 0, 55);
        Event event8 = new Event(8L, "Carmen", "Operă dramatică de Bizet", LocalDate.of(2025, 2, 8), venue4, 0, 60);
        Event event9 = new Event(9L, "Don Giovanni", "Operă în 2 acte de Mozart", LocalDate.of(2025, 3, 5), venue3, 0, 80);
        Event event10 = new Event(10L, "Concert de Crăciun", "Eveniment special de sărbători", LocalDate.of(2025, 1, 20), venue2, 0, 40);
        Event event11 = new Event(11L, "Macbeth", "Tragedie intensă de William Shakespeare", LocalDate.of(2025, 9, 10), venue1, 0, 45);
        Event event12 = new Event(12L, "Tosca", "Operă dramatică de Giacomo Puccini", LocalDate.of(2025, 10, 5), venue2, 0, 70);
        Event event13 = new Event(13L, "Spărgătorul de nuci", "Balet de Piotr Ilici Ceaikovski", LocalDate.of(2025, 12, 15), venue3, 0, 65);
        Event event14 = new Event(14L, "Aida", "Operă grandioasă de Verdi", LocalDate.of(2024, 11, 2), venue2, 0, 90);
        ...
        Event event16 = new Event(16L, "Madama Butterfly", "Operă tragică de Puccini", LocalDate.of(2024, 11, 18), venue3, 0, 75);
